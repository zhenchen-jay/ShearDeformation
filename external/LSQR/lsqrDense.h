...
public:
   ...
   */
  void Aprod1(int m, int n, const double * x, double * y ) const;
   ...
   * The size of the vector y is m.
   */
  void Aprod2(int m, int n, double * x, const double * y ) const;
  ...
  void HouseholderTransformation(int n, const double * z, double * x ) const;
