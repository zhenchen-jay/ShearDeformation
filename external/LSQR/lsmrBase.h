...
public:
   ...
   */
  virtual void Aprod1(int m, int n, const double * x, double * y ) const = 0;
   ...
   * The size of the vector y is m.
   */
  virtual void Aprod2(int m, int n, double * x, const double * y ) const = 0;
   ...
   * with precautions to avoid overflow.
   */
  double Dnrm2(int n, const double *x ) const;

  /**
   * Scale a vector by multiplying with a constant
   */
  void Scale(int n, double factor, double *x ) const;
  ...
  int GetNumberOfIterationsPerformed() const;
   ...
   */
  void Solve(int m, int n, const double * b, double * x );
