 ...
 */
void lsqrDense::
Aprod1(int m, int n, const double * x, double * y ) const
{
 ...
 */
void lsqrDense::
Aprod2(int m, int n, double * x, const double * y ) const
{
  for ( int col = 0; col < n; col++ )
    {
    double sum = 0.0;
...
*/
void lsqrDense::
HouseholderTransformation(int n, const double * z, double * x ) const
{
