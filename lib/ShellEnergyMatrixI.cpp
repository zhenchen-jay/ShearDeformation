...
void ShellEnergyMatrixI::streching_energy(Eigen::MatrixXd V, Eigen::MatrixXd V0, Eigen::MatrixXi F, double YoungsModulus, double PossionRatio, double thickness, double &E, Eigen::VectorXd &dE)
{
...
void ShellEnergyMatrixI::bending_energy(Eigen::MatrixXd V, Eigen::MatrixXd V0, Eigen::MatrixXi F, double YoungsModulus, double PossionRatio, double thickness, double &E, Eigen::VectorXd &dE)
{
    if(L_list.size() != 3*F.rows())
    {
        std::cout<<"Please load the required coefficient first!"<<std::endl;
...
void ShellEnergyMatrixI::test_bending_energy()
{
